////
////  WXSMoviePlayerViewController.m
////  WXSparkApp
////
...
//
//@interface WXSMoviePlayerViewController ()
//
//@end
//
//@implementation WXSMoviePlayerViewController
//
//- (void)viewDidLoad {
//    [super viewDidLoad];
...
@interface WXSMoviePlayerViewController ()<ZFPlayerDelegate>
/** 播放器View的父视图*/
...
- (void)zf_playerDownload:(NSString *)url {
    ...
    [[WXSCacheTool sharedTool] downLoad:url];
}
